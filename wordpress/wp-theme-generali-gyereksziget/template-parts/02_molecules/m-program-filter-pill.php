<div class="program-filter--date-filter">
    <div class="js-program-date-filter-pill program-filter--date-filter--pill"></div>
    <?php foreach ($dates as $i => $date) : ?>
        ...
        <p class="program-filter--date-filter--date js-program-date-filter" data-id="<?php echo $i; ?>" data-date="<?php echo $date_id; ?>">
            <?php echo $date_name; ?>
        </p>
    <?php endforeach; ?>
</div>