...
if (function_exists('acf_add_options_page')) {
    ...
    acf_add_options_page(array(
        'page_title' => _x('General Settings', 'menu-name', 'waterside'), // The title of the page to be displayed in the browser
        'menu_title' => _x('General Settings', 'menu-name', 'waterside'), // The text to be used for the menu item
