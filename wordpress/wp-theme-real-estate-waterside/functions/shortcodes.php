...
class Shortcode_Builder
{
    ...
    {
        $plugin_array['custom_shortcodes'] = get_template_directory_uri() . '/assets/js/admin/shortcodes-inline.js';
        return $plugin_array;
    }
    ...
    public function admin_head()
    {
        ...
        wp_enqueue_script('shortcodes-editor-view', get_template_directory_uri() . '/assets/js/admin/shortcodes-editor-view.js', array('shortcode', 'wp-util', 'jquery', 'media-views'), false, true);
    }
}
